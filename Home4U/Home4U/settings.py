...
PAYSTACK_URL_INITIALIZE = os.getenv("PAYSTACK_URL_INITIALIZE")
PAYSTACK_URL_VERIFY = os.getenv("PAYSTACK_URL_VERIFY")
print(FLW_SECRET_HASH)
print(f"verify: {PAYSTACK_URL_VERIFY}")
print(f"initilize: {PAYSTACK_URL_INITIALIZE}")
print(f"key: {PAYSTACK_SECRET_KEY}")
